...
@Aliases("apply")
@Permission("atherysskills.effect.apply")
public class ApplyEffectCommand implements ParameterizedCommand {
    @Nonnull
    @Override
    public CommandResult execute(@Nonnull CommandSource source, @Nonnull CommandContext args) throws CommandException {
        ...
        AtherysSkills.getInstance().getEffectFacade().applyEffect(player, effect);
