 ...
 */
public interface CastableCarrier<T extends Living> extends LivingRepresentable<T> {
     ...
     */
    Map<Castable, CastableProperties> getSkills();
    ...
    default boolean hasCastable(Castable castable) {
        return getSkills().containsKey(castable);
    }
    ...
    default void putCastable(Castable castable, CastableProperties properties) {
        getSkills().put(castable, properties);
    }
    ...
    default void addCastable(Castable castable) {
        getSkills().put(castable, castable.getDefaultProperties());
    }
    ...
    default Optional<? extends Castable> getCastableById(String id) {
        for (Castable castable : getSkills().keySet()) if (castable.getId().equals(id)) return Optional.of(castable);
    ...
    default Optional<CastableProperties> getProperties(Castable castable) {
        return Optional.ofNullable(getSkills().get(castable));
    }
